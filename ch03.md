...
| Task                                                              | Status     |
|-------------------------------------------------------------------|------------|
| Opzetten ontwikkelomgeving                                        | unfinished |
...
| Label van respec document dynamisch maken                         | unfinished |
| Configuratie bestand opsplitsen op basis van type configuratie    | unfinished |
